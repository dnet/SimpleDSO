...
test_wx = Target(
    ...
    description = "App to get screenshot from UNI-T DSO",

    # what to build
    script = "simpleDSO.py",
    other_resources = [(RT_MANIFEST, 1, manifest_template % dict(prog="simpleDSO"))],
...
raw_input("\nHotovo, stiskem enter ukoncite skript")
